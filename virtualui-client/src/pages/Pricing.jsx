...
const Pricing = () => {
  ...
  const handlePayment = async (plan) => {
    try {
      ...
      const options = {
        ...
        currency: "INR",
        name: "Virtual.UI",
        description: `${plan.name} - ${plan.aiCredits} Credits`, // ✅ Fixed: was plan.credits
      ...
      const rzp = new window.Razorpay(options); // ✅ Fixed: options was missing
      rzp.open();
    } catch (error) {
      console.error("Payment error:", error); // ✅ Fixed: empty catch
    }
  };
  ...
  return (
    ...
    >
      <style>
        {`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,9;0,400;0,1000;1,9;1,400;1,1000&family=Syne:wght@400..800&display=swap');`}
      </style>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {plans.map((plan, i) => (
            ...
            >
              ...
              {/* CTA Button — ✅ Fixed: onClick added */}
              <button
